document.addEventListener("DOMContentLoaded", () => {
  ...
  function adicionarItem(texto) {
    ...
    const cointainerBotoesSalvarCancelar = document.createElement("div");
    ...
    cointainerBotoesSalvarCancelar.append(botaoSalvar);
    cointainerBotoesSalvarCancelar.append(botaoCancelar);

    cointainerBotoesSalvarCancelar.classList.add("container-botoes-salvar-cancelar", "esconder-botoes");

    item.append(input);
    item.append(containerBotoes);
    item.append(cointainerBotoesSalvarCancelar);
